...
function extract(html) {
  ...
  // Season page link from breadcrumb or page structure
  const seasonLink = (html.match(/<a[^>]*href="(\/season\/[^"]+)"[^>]*>مسلسل/) || [])[1];

  return { title, servers, downloads, episodes, seasonLink };
}
...
export { resolve, deepResolveDownload };
